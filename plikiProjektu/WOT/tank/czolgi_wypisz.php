...
<div class="container-fluid" style=" height: 100vh; ">
	<h2 class="tytul" > PEŁNA LISTA CZOŁGÓW </h2>
<div class="row" style="height: 100%">
	    ...
	    <div class="col-sm-3"style="text-align: center; margin-top: 5%;">	
				...
				<form action="czolgi_wypisz.php" method="post">
				...
				$zapytanie = "SELECT * FROM czolg join typczolgu using (typ) order by " . $po . ";";
				$zap = mysqli_query($wot, $zapytanie);
				?>	
				<br><br>
				<br><br>
				<a href = "dodaj_czolg.php" class="btn btn-outline-secondary" role="button" style=" width : 60%; height: 40px; margin-bottom: 20px;">DODAJ NOWY</a> 
				...
				<table class="table table-hover" style=" text-align: center;">
					...
					<?php
						...
						while($wiersz = mysqli_fetch_assoc($zap)) 
						{
					        ...
					        <td>
					        	<form action="modyfikujCzolg.php" method="POST">
									<input type="hidden" name="id" value="<?php echo $wiersz['nazwa']?>">
									<input type="submit" name="modyfikacjaKlanu" value="zmień" >
								</form>
								<br>
								<form action="obsluga_czolgi.php" method="POST">
									<input type="hidden" name="id" value="<?php echo $wiersz['nazwa']?>">
									<input type="submit" name="czolgUsun" value="usuń"  >
								</form>
							</td>
					      	</tr>
					    <?php
